            ...
            <DialogContent className="bg-white">
                ...
                <form className="flex flex-col gap-4 w-full">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <textarea className= {inputStyle} id="descripition"></textarea>
                    </div>

                    {/*URL da imagem*/}
                    <div className="flex flex-col gap-1">
                        <label htmlFor="imageUrl">URL da imagem</label>
                        <input type="text" className= {inputStyle} id="descripition" placeholder="/placeholder.svg"></input>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input className = {inputStyle} type="text" id="title" placeholder="15 minutos" />
                        </div>

                        {/*Tempo de cozimento*/}
                        <div className="flex flex-col gap-1">
                            <label htmlFor="cookTime">Tempo de cozimento</label>
                            <input className = {inputStyle} type="text" id="title" placeholder="30 minutos" />
                        </div>

                        {/*Porções*/}
                        <div className="flex flex-col gap-1">
                            <label htmlFor="servings">Porções</label>
                            <input className = {inputStyle} type="number" id="title" defaultValue={1}/>
                        </div>
                    </div>
